...
{
    // Input pin 1 is the clock, connected to the node at pin 0. The other inputs (0, 2, and 3) are
    // mapped by the D-Latch with SR
...
void DCSDFlipFlopAsyncSR::updateOut() { DCSLog::error(name, 0); }
