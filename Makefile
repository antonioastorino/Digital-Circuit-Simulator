...
build/objects/Bus-test.o: .//src/Tests/Bus-test.cpp .//include/DCSAnd.hpp .//include/DCSComponentArray.hpp .//include/DCSEngine.hpp .//include/DCSInput.hpp .//include/DCSLog.hpp .//include/DCSNode.hpp .//include/DCSNot.hpp .//include/DCSOutput.hpp .//include/DCSTriStateBuffer.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
