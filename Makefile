...
build/objects/prj-countByThrees.o: .//src/Projects/prj-countByThrees.cpp  build/objects/DCSALU.o build/objects/DCSControlUnit5Bits.o build/objects/DCSEngine.o build/objects/DCSInput.o build/objects/DCSLog.o build/objects/DCSOutput.o build/objects/DCSRam16x8.o build/objects/DCSRegister1Bit.o build/objects/DCSRegister4Bits.o build/objects/DCSRegister8Bits.o build/objects/DCSTriStateBuffer8Bits.o build/objects/DCSUpCounterWithLoadAndAsyncSR.o build/objects/DCSPLD8In16Out.o 
	$(CC) $(INC) $(CFLAGS) $< -o $@

build/objects/prj-all.o: .//src/Projects/prj-all.cpp .//include/DCSLog.hpp .//src/Projects/prj-FastControlUnit.hpp .//src/Projects/prj-countByThrees.hpp .//src/Projects/prj-NoCUComputer.hpp .//src/Projects/prj-fastZeroFlagProgram.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
...
build/objects/prj-FastControlUnit.o: .//src/Projects/prj-FastControlUnit.cpp .//src/Projects/prj-countByThrees.hpp build/objects/DCSPLD8In16Out.o build/objects/DCSDisplayNBits.o build/objects/DCSEngine.o build/objects/DCSLog.o build/objects/DCSRam256x16.o 
	$(CC) $(INC) $(CFLAGS) $< -o $@
...
build/objects/test-AddressDecoder8Bits.o: .//src/Tests/test-AddressDecoder8Bits.cpp .//src/Tests/test-AddressDecoder8Bits.hpp build/objects/DCSLog.o build/objects/DCSInput.o build/objects/DCSOutput.o build/objects/DCSEngine.o build/objects/DCSAddressDecoder8Bits.o build/objects/DCSComponentArray.o 
	$(CC) $(INC) $(CFLAGS) $< -o $@
