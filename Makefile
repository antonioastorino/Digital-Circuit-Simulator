...
build/objects/Demo-test.o: .//src/Tests/Demo-test.cpp .//include/DCSAnd.hpp .//include/DCSEngine.hpp .//include/DCSLog.hpp .//include/DCSInput.hpp .//include/DCSOutput.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
