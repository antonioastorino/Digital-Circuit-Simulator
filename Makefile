...
build/objects/FirstProgram-Test.o: .//src/Tests/FirstProgram-Test.cpp .//include/DCSEngine.hpp .//include/DCSInput.hpp .//include/DCSLog.hpp .//include/DCSOutput.hpp .//include/DCSRam16x8.hpp .//include/DCSTriStateBuffer8Bits.hpp .//include/DCSUpCounterWithLoadAndAsyncSR.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
...
build/objects/ControlUnit-test.o: .//src/Tests/ControlUnit-test.cpp .//include/DCSLog.hpp .//include/DCSEngine.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
