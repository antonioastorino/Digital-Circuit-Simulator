...
build/objects/Ram256x16-test.o: .//src/Tests/Ram256x16-test.cpp .//include/DCSLog.hpp .//include/DCSInput.hpp .//include/DCSOutput.hpp .//include/DCSEngine.hpp .//include/DCSComponentArray.hpp .//include/DCSRam256x16.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
