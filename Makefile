...
build/objects/FastControlUnit-test.o: .//src/Tests/FastControlUnit-test.cpp .//include/DCSAddressDecoder8Bits.hpp .//include/DCSComponentArray.hpp .//include/DCSEngine.hpp .//include/DCSInput.hpp .//include/DCSInstructionSet.hpp .//include/DCSLog.hpp .//include/DCSOr.hpp .//include/DCSDisplayNBits.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
