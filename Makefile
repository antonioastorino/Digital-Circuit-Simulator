...
build/objects/FastControlUnit-test.o: .//src/Tests/FastControlUnit-test.cpp .//include/DCSPLD8In16Out.hpp .//include/DCSDisplayNBits.hpp .//include/DCSInstructionSet.hpp .//include/DCSEngine.hpp .//include/DCSLog.hpp 
	$(CC) $(INC) $(CFLAGS) $< -o $@
